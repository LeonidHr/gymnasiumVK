 ...
 */
            var WheelIndicator = function() {
                ...
                Module.prototype = {
                    ...
                    getOption: function(option) {
                        ...
                        if (void 0 !== neededOption) return neededOption;
                ...
                var getDeltaY = function(event) {
                    if (event.wheelDelta && !event.deltaY) getDeltaY = function(event) {
                        return -1 * event.wheelDelta;
                    }; else getDeltaY = function(event) {
                        return event.deltaY;
                    };
                ...
                function processDelta(event) {
                    var self = this, delta = getDeltaY(event);
                    if (0 === delta) return;
                    var sustainableDirection, i, direction = delta > 0 ? "down" : "up", arrayLength = self._deltaArray.length, changedDirection = false, repeatDirection = 0;
                    ...
                    for (i = 0; i < arrayLength; i++) if (0 !== self._deltaArray[i]) self._deltaArray[i] > 0 ? ++repeatDirection : --repeatDirection;
                    ...
                    if (!self._isStopped) if (changedDirection) {
                        self._isAcceleration = true;
                        triggerEvent.call(this, event);
                    } else if (Math.abs(repeatDirection) === arrayLength) analyzeArray.call(this, event);
                    if (self._isStopped) {
                ...
                function analyzeArray(event) {
                    var deltaArray0Abs = Math.abs(this._deltaArray[0]), deltaArray1Abs = Math.abs(this._deltaArray[1]), deltaArray2Abs = Math.abs(this._deltaArray[2]), deltaAbs = Math.abs(getDeltaY(event));
                    if (deltaAbs > deltaArray2Abs && deltaArray2Abs > deltaArray1Abs && deltaArray1Abs > deltaArray0Abs) if (!this._isAcceleration) {
                        triggerEvent.call(this, event);
                ...
                function addEvent(elem, type, handler) {
                    if (elem.addEventListener) elem.addEventListener(type, handler, isPassiveSupported() ? {
                        passive: false
                    } : false); else if (elem.attachEvent) elem.attachEvent("on" + type, handler);
                }
                function removeEvent(elem, type, handler) {
                    if (elem.removeEventListener) elem.removeEventListener(type, handler, isPassiveSupported() ? {
                        passive: false
                    } : false); else if (elem.detachEvent) elem.detachEvent("on" + type, handler);
                }
                function extend(defaults, options) {
                    var prop, extended = {};
                    for (prop in defaults) if (Object.prototype.hasOwnProperty.call(defaults, prop)) extended[prop] = defaults[prop];
                    for (prop in options) if (Object.prototype.hasOwnProperty.call(options, prop)) extended[prop] = options[prop];
                    return extended;
                }
                return Module;
            }();
            if (true) module.exports = WheelIndicator;
    ...
    (() => {
        ...
        function showPopup(form, isSucsess, response = "") {
            setTimeout((() => {
                if (flsModules.popup) {
                    const popup = form.dataset.popupMessage, popupTitle = document.querySelector("[data-popap-title]");
                    if (isSucsess) popupTitle.innerHTML = "Успешно отправлено"; else popupTitle.innerHTML = `Ошибка ${response.status}. Форма не отправлена`;
        ...
        function initSliders() {
            if (document.querySelector(".founder-slider")) {
                const founderSlider = new core(".founder-slider", {
                ...
                if (!isMobile.any()) {
                    ...
                    document.addEventListener("wheel", (e => {
                        console.log(e);
                        if (e.deltaY > 0 && document.querySelector(".founder-slider").classList.contains("_watcher-view")) stoppedViewport("down", founderSlider, ".founder-slider");
                        if (e.deltaY < 0 && document.querySelector(".founder-slider").classList.contains("_watcher-view")) stoppedViewport("up", founderSlider, ".founder-slider");
                    }));
                }
            }
            if (document.querySelector(".whom-slider")) {
                const whomSlider = new core(".whom-slider", {
                ...
                if (!isMobile.any()) {
                    ...
                    document.addEventListener("wheel", (e => {
                        console.log(e);
                        if (e.deltaY > 0 && document.querySelector(".whom-slider").classList.contains("_watcher-view")) stoppedViewport("down", whomSlider, ".whom-slider");
                        if (e.deltaY < 0 && document.querySelector(".whom-slider").classList.contains("_watcher-view")) stoppedViewport("up", whomSlider, ".whom-slider");
                    }));
                }
            }
            if (document.querySelector(".you-get-slider")) new core(".you-get-slider", {
            ...
            if (document.querySelector(".coursers-img-slider")) new core(".coursers-img-slider", {
            ...
            if (document.querySelector(".histories-slider")) new core(".histories-slider", {
            ...
            if (document.querySelector(".histories-img-slider-main")) document.querySelectorAll(".histories-img-slider").forEach(((slider, i) => {
                new core(".histories-img-slider-main", {
                    modules: [ Pagination, Controller, Thumb, Mousewheel, Autoplay ],
            ...
            if (document.querySelector(".popup-quiz-slider")) new core(".popup-quiz-slider", {
            ...
            if (document.querySelector(".about-reviews-slider")) new core(".about-reviews-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            if (document.querySelector(".review-slider")) new core(".review-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
        ...
        function stoppedViewport(direction, sliderObj, sliderClass) {
            ...
            if ("down" === direction) if (window.innerHeight / 2 > slider.getBoundingClientRect().top) {
                enableSlider(sliderObj);
                if (slides[slides.length - 1].classList.contains("swiper-slide-active")) disableSlider(sliderObj);
            }
            if ("up" === direction) if (window.innerHeight / 1.5 < slider.getBoundingClientRect().bottom) {
                enableSlider(sliderObj);
                if (slides[0].classList.contains("swiper-slide-active")) disableSlider(sliderObj);
            }
        }
        ...
        if (document.querySelector("#mainscreen-img") && window.innerWidth > 767) {
            ...
            new ScrollMagic.Scene({
                triggerElement: "#trigger-main",
                duration: 400
            }).setTween("#mainscreen-img", {
                scale: .5
            }).addTo(controller);
        }
        ...
        if (document.querySelector(".prlx")) {
            ...
            for (var i = 0; i < slides.length; i++) new ScrollMagic.Scene({
        ...
        if (document.querySelector(".ready__title") && window.innerWidth < 1500 && window.innerWidth > 992) {
            ...
            new ScrollMagic.Scene({
                triggerElement: "#trigger4",
                duration: 300
            }).setTween(".ready__title", {
                marginLeft: 150,
                scale: .8,
                opacity: 1
            }).addTo(controller);
        }
        if (window.innerWidth > 767) window.addEventListener("scroll", smallingMainscreenSlide);
        function smallingMainscreenSlide() {
            if (document.querySelector(".mainscreen")) {
                ...
                if (lastSlide.getBoundingClientRect().top < window.innerHeight) slides.forEach((slide => {
        ...
        if (window.innerWidth > 767) if (document.querySelector(".founder-slider__wrapper")) document.querySelector(".founder-slider__wrapper").addEventListener("transitionend", addActiveForColtainer);
        function addActiveForColtainer() {
            ...
            if (lastSlide.classList.contains("swiper-slide-active")) container.classList.add("_active");
        }
        updateRange();
        ...
        if (isMobile.any()) addClickPrices();
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
